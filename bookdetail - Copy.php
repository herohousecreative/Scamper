...
<form action="'.$PHP_SELF.'" method="post">
  ...
  <input type="checkbox" name="RFB" value="ON" '; if (in_array("RFB",$file_formats)) echo "checked"; echo '>RFBD
...
{
	$format_array = array("TXT","HTML","PDF","RTF","DOC","DTB","DXB","RFB","MP3","TEX","VOL","XML");
