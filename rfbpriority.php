...
echo '
  <div id="pageName"> 
    <h2>Learning Ally (RFB&D) Priority Tracking </h2> 
  </div> 
    <div id="content"> 
    <div class="feature">
  <table width=100%>
  	<tr>
		  <td>
		  	<font face="arial"><strong>Priority Ranking for Learning Ally (RFB&amp;D) List</strong><br>
			1. Not Ordered<br>
			2. Ordered, not received (waiting for delivery)<br>
...
// display the current and upcoming semester RFB book list
$result = select_rfbpriority($semester, $nextsemester);
$num_results = mysql_num_rows($result);
echo "<p><h2>Number of Learning Ally (RFB&amp;D) books requests for the current or an upcoming semester: ".$num_results."</h2></p>";
...
$season=$semester[2];
  ...
  echo '<table width="100%" cellpadding="1">
	...
	<TD width=25%><strong><font color="#FFFFFF">Title</font></strong></TD>
  	 ...
  	 <TD width=20%><strong><font color="#FFFFFF">Request Notes - indicate installments<br>(viewable by student in GMB)</font></strong></TD>
	 <TD width=13%><strong><font color="#FFFFFF">Student</font></strong></TD>
	 <TD width=5%><strong><font color="#FFFFFF">Sem</font></strong></TD>
	 <TD width=4%><strong><font color="#FFFFFF">Edit<br>Request</font></strong></TD>
  	</TR>';
...
if (db_numrows($result) == 0) {
  ...
  for ($i=0; $i <$num_results; $i++)
  {
    ...
    echo '<TD align="center"><input name="'.$row["FTTEBOOKID"].'" type="text" size="2" maxlength="3" value="'.$row["fpriority"].'" /></TD>
		...
		<TD>20'.$row["reqsemester"].'</TD>
	    <TD><a href="requestdetail.php?requestid='.$row["primarykey"].'">Edit</a></TD>
	</TR>';
...
//-----------------------------------------------------------
$result = select_rfbpriority_incomplete($semester, $nextsemester);
$num_results = mysql_num_rows($result);
echo "<p><h2>Number of Learning Ally (RFB&amp;D) books not resolved: ".$num_results."</h2></p>";
...
$season=$semester[2];
  ...
  echo '<table width="100%" cellpadding="1">
	...
	<TD width=25%><strong><font color="#FFFFFF">Title</font></strong></TD>
  	 ...
  	 <TD width=2% align="center"><strong><font color="#FFFFFF">Out</font></strong></TD>
  	 <TD width=2% align="center"><strong><font color="#FFFFFF">In</font></strong></TD>
  	 <TD width=20%><strong><font color="#FFFFFF">Request Notes<br>(viewable by student in GMB)</font></strong></TD>
	 <TD width=13%><strong><font color="#FFFFFF">Student</font></strong></TD>
	 <TD width=5%><strong><font color="#FFFFFF">Sem</font></strong></TD>
	 <TD width=4%><strong><font color="#FFFFFF">Edit</font></strong></TD>
  	</TR>';

//if($season == 'C')
//{
//	$semester1 = sprintf("%sB", $year);
//	$result = select_rfbpriority_incomplete($semester1);
