...
<a href="http://studentlife.tamu.edu/ssd/">Disability Services Department</a> |
</center><br>
<hr>
	<a name="Student Request"><h2>Student Request</h2></a>
<p>The only way to request a book now is for a student to go to <a href="http://getmybooks.tamu.edu">getmybooks.tamu.edu</a> and request a book.  
...
something.  Proceed to accept the book request.  This will send it to the Priority List. </ul>
		...
		<ul>**Note for I & II: Be sure to input the RFBD number and date received/found under the books details.  You have to click update book for the information to be entered.  Then, under the books details, at the bottom of the page, click on the student requesting the book.  From this page click on the title of the book youre currently entering information for and enter the called dates.  (this will be simplified in near future)</ul>
	...
	<p>B.  If .txt or .html, search <a href="https://getmybooks.tamu.edu">getmybooks.tamu.edu</a> once again, but check to see if there is a word missing in the title, or if there are too many words in the title.  (i.e. The included or not, a misspelling, etc.)  As of right now, you may want to check with <a href="https://tte.tamu.edu">tte.tamu.edu</a>, <a href="https://scamper.tamu.edu">scamper.tamu.edu</a>, and our books drive just to be positive that we do not have the e-text somewhere.
		<ul>I.  If you do find the book, inform the student by email to let them know precisely where it is located.<br>
			<ol>a.  If the book is currently on scamper and it was just missed, then deny the request saying that it is already in getmybooks.  Then go to the students account and add a request.  You can only add one book at a time or it will not function.</ol><br>
			<ol>b.  If the book is not currently on scamper, but is on tte or books drive, then accept the request.  This adds the books information to our books list on scamper and automatically puts it on our priority list.  Upload the book to SCAMPER from the books details page.  (Click Click here to view books contents at the top of the page.  Then proceed to click here to upload files.  You can only do one file at a time.  So, it is helpful to make a zip file and just upload the zip.)  The students will be able to access the book through <a href="https://getmybooks.tamu.edu">getmybooks.tamu.edu</a>.</ol></ul>
...
Missing pages:  Find exactly where the first missing page is.  Delete all the pages after it.  Pick up scanning again at those pages.  This is the least time consuming method.  It is help to periodically check the page #s during the scanning.
