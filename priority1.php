...
echo '
  ...
  <div id="content"> 
	...
	<p><strong>Key:</strong><br>
  		...
  		O = OCR<br>
  		C = check<p>
<pre><font face="arial"><strong>Semester:				Priority Ranking:</strong>
A: Spring semester				 1-19:  Books currently in processing
B: Summer semester				 20: Books currently in processing that need to be .mp3’s
C: Fall Semester				 30: Books that need to be bought from the bookstore
					 40: Books to be recorded.
		</font></pre>
	';
...
echo '<table width="100%" cellpadding="1">
	 <TR bgcolor="#666666">
  	 ...
  	 <TD width=34%><strong><font color="#FFFFFF">Title</font></strong></TD>
	 ...
	 <TD width=14%><strong><font color="#FFFFFF">Student</font></strong></TD>
	 <TD width=5%><strong><font color="#FFFFFF">Semester</font></strong></TD>
  	 <TD width=13% align="center"><strong><font color="#FFFFFF">Format</font></strong></TD>
	 <TD width=6%><strong><font color="#FFFFFF">Delete</font></strong></TD>
  	 </TR>';
...
echo '<table width="100%" cellpadding="1">
	 <TR bgcolor="#666666">
  	 ...
  	 <TD width=2% align="center"><strong><font color="#FFFFFF">O</font></strong></TD>
  	 <TD width=2% align="center"><strong><font color="#FFFFFF">C</font></strong></TD>
  	 <TD width=10%><strong><font color="#FFFFFF">Notes</font></strong></TD>
	 <TD width=14%><strong><font color="#FFFFFF">Student</font></strong></TD>
	 <TD width=5%><strong><font color="#FFFFFF">Semester</font></strong></TD>
  	 <TD width=13% align="center"><strong><font color="#FFFFFF">Format</font></strong></TD>
	 <TD width=6%><strong><font color="#FFFFFF">Delete</font></strong></TD>
