...
echo"<h4>(Click on Request Date to view Request Details)</h3><br>\n";
echo "<h3>Total requests: ",db_numrows($result),"</h3>\n";
echo "<table border=\"0\" width=100%>\n";
echo "<TR  bgcolor=\"#666666\">\n";
echo "<TD width=40%><strong><font color=\"#FFFFFF\">Student Name</strong></font></TD>\n";
echo "<TD width=30%<strong><font color=\"#FFFFFF\">Email</strong></font></TD>\n";
echo "<TD width=30%><strong><font color=\"#FFFFFF\">Request Date</strong></font></TD>\n";
echo "</TR>\n";
...
do {
 ...
 echo "<TD><a href=\"requestdetail1.php?requestid=",$row["reqid"],"\">",$row["reqdate"],"</a></TD>\n";
  echo "</TR>\n";
  //rotate the color for the table
  if ($color_switch)
  {
