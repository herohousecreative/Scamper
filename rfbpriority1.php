...
echo '
  ...
  <div id="content"> 
    <div class="feature"> 
	<p><br> <pre> <font face="arial"><strong>Priority Ranking for BOT List								Semester</strong>
  1. Not Ordered  				P/U = Waiting For Pickup			A: Spring Semester
  2. Ordered, not received			Order = Ordered; coming from RFB&D		B: Summer Semester
  3. Received, waiting for pick up 			Out = Checked Out				C: Fall Semester
  4. Checked out				In = In Storage							
  5. Overdue to be returned
		</font></pre>
	';
