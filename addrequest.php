...
echo '
  <div id="pageName"> 
    ...
    <h3><a href="addrequestbot.php?studentid='.$studentid.'">Add Book Request for RFBD Book on CD/Tape</a>  |    <a href="addrequestetext.php?studentid='.$studentid.'">Add Book Request for e-Text </a></h3>
  </div> 
  <div id="content"> 
    <div class="feature"> 
';
...
if (db_numrows($result) == 0) {
  ...
  echo "<form action='addrequest.php?studentid=".$_GET[studentid]."' method='post'>";
  ...
  echo "<TD width=15%><strong><font color=\"#FFFFFF\">Author(s)</strong></font></TD>";
...
echo "<h3><a href='studentdetail.php?studentkey=".$studentid."'>View Student Details</a></h3>";
