...
echo"<h3>Current Book Requests (Grouped by Title)</h3>";
$result=select_requestquerybytitle($studentkey,$semester,$semquery);

$year=substr($semester,0,2);
$season=$semester[2];

echo "<h2>Total ",$semquery," requests: ",db_numrows($result),"</h2>";
