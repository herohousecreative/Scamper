...
//	echo $delreqsql;
 ...
 // display the upcoming semester priority title list - added 11/21/05
$result = select_priority($nextsemester);
$num_results = mysql_num_rows($result);
echo "<p><h2>Number of books in upcoming semester: ".$num_results."</h2></p>";
...
if($season == 'B' || $season == 'A')
{
 ...
 // display the current semester priority title list
